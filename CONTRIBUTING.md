...
To help improve Mist (_Japariyen Wallet_), please include the following:
...
```
/**
The IPC provider backend filter and tunnel all incoming request to the IPC gjpy bridge.
