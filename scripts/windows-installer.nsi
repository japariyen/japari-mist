...
!macro ENVFUNC un
  Function ${un}setenv
    ...
    StrCpy $NODEDATADIR "$APPDATA\Japariyen"
...
Section Mist MIST_IDX
    ...
    ## Firewall - add rules
    #SimpleFC::AdvAddRule "Gjpy incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$DATADIR\binaries\Gjpy\unpacked\gjpy.exe" "" "" "Japariyen" 30303 "" "" ""
    #SimpleFC::AdvAddRule "Gjpy outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$DATADIR\binaries\Gjpy\unpacked\gjpy.exe" "" "" "Japariyen" "" 30303 "" ""
    #SimpleFC::AdvAddRule "Gjpy UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$DATADIR\binaries\Gjpy\unpacked\gjpy.exe" "" "" "Japariyen" "" 30303 "" ""
...
Section "uninstall"
    ...
    #SimpleFC::AdvRemoveRule "Gjpy incoming peers (TCP:30303)"
    #SimpleFC::AdvRemoveRule "Gjpy outgoing peers (TCP:30303)"
    #SimpleFC::AdvRemoveRule "Gjpy UDP discovery (UDP:30303)"
